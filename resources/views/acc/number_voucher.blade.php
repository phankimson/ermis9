...
@section('content_add')
    ...
    <table>
      ...
      <td>
      <select class="droplist large" data-position="1" data-title="@lang('acc_number_voucher.middle_type')" data-template="#= FormatDropList(middle_type,'middle_type') #" data-type="number" data-width="200px" name="middle_type">
              <option readonly selected value="">@lang('global.select')</option>              
              <option value="DD">@lang('acc_number_voucher.for') @lang('acc_number_voucher.day')</option>
              <option value="MM">@lang('acc_number_voucher.for') @lang('acc_number_voucher.month')</option>
              <option value="YY">@lang('acc_number_voucher.for') @lang('acc_number_voucher.year')</option>
              <option value="YYYY">@lang('acc_number_voucher.for') @lang('acc_number_voucher.year_full')</option>
              <option value="MMYY">@lang('acc_number_voucher.for') @lang('acc_number_voucher.month') @lang('acc_number_voucher.year')</option>
              <option value="DDMMYY">@lang('acc_number_voucher.for') @lang('acc_number_voucher.date')</option>
      </select>
      </td>
      </tr>
      <tr>
          <td class="row-label"><label>@lang('acc_number_voucher.middle') </label></td>
          <td><input type="text" class="k-textbox xxlarge" data-position="3" data-title="@lang('acc_number_voucher.middle')" data-width="200px" maxlength="100" data-type="string" name="middle" /></td>
      </tr>   
      <tr>
      ...
      <tr>
          ...
          <td><input type="text" class="k-textbox xxlarge" data-position="3" data-title="@lang('acc_number_voucher.suffixes')" data-width="200px" maxlength="100" data-type="string" name="suffixes" /></td>
      </tr>
      <tr>
